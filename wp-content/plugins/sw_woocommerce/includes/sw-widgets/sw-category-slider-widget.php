			...
			vc_map( array(
			  ...
			  "params" => array(
				...
				array(
					...
					'dependency' => array(
						'element' => 'layout',
						'value' => array( 'default','theme1','theme2','theme3','theme4', 'theme5','theme6','theme7','theme8' )
					),
				 ),	
				  array(
					"type" => "multiselect",
					...
					"dependency" => array(
						'element' => 'layout',
						'value' => array( 'default','theme1','theme2','layout2','layout3','theme3','theme4','theme5','theme6','theme7','theme8' )
					),
				 ),
				   array(
					"type" => "dropdown",
					...
					"param_name" => "style",
					"admin_label" => true,
					"value" => array( '' => 'Select', 'style1' => 'style1' ),
				 ...
				 array(
					...
					'dependency' => array(
						'element' => 'layout',
						'value' => array( 'default', 'theme1','theme2','layout2','theme3','theme4','theme6','theme8' )
					),
				 ),
				 array(
					"type" => "dropdown",
				 ...
				 array(
				  ...
				  array(
					...
					"param_name" => "layout",
					"admin_label" => true,
					"value" => array( 'Layout Default' => 'default', 'Layout Theme1' => 'theme1', 'Layout Theme2' => 'theme2', 'Layout Theme3' => 'theme3', 'Layout Theme4' => 'theme5', 'Layout Theme5' => 'theme6', 'Layout Theme6' => 'theme7', 'Layout Theme7' => 'theme8', 'Layout Category Ajax' => 'layout2', 'Layout Mobile' => 'layout3',  'Layout Mobile2' => 'theme4', 'Layout Mobile Ajax' => 'layout4' ),
