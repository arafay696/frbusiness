				...
				array(
				 ...
				 array(
				  ...
				  array(
					...
					"dependency" => array( 
						'layout' => array( 'childcat3', 'childcat4' )
						)
					),
				array(
					"type" => "textfield",
				 ...
				 array(
					...
					'dependency' => array(
						'element' => 'layout',
						'value' => array('childcat1', 'childcat2', 'childcat3', 'childcat4' )
					),
				 ),
				 array(
					'type' => 'date',
					...
					'dependency' => array(
						'element' => 'layout',
						'value' => array( 'layout6','bestsales3', 'bestsales5' ),
					 )
				),
				  array(
					"type" => "dropdown",
				 ...
				 array(
				  ...
				  array(
					...
					"param_name" => "layout",
					"admin_label" => true,
					"value" => array( 'Layout Default' => 'default', 'Layout 1' => 'default1', 'Layout 2' => 'default2', 'Layout Featured' => 'featured', 'Layout Featured 2' => 'featured2', 'Layout Featured 3' => 'featured3', 'Layout Featured 4' => 'featured4',  'Layout Featured Mobile' => 'featured_mobile', 'Layout Top Rated' => 'toprate', 'Best Sales Mobile' => 'bestsales-mobile', 'Layout Mobile 2' => 'theme-mobile', 'Layout Best Sales' => 'bestsales', 'Layout Best Sales 2' => 'bestsales2', 'Layout Best Sales 3' => 'bestsales3', 'Layout Best Sales 4' => 'bestsales4', 'Layout Best Sales 5' => 'bestsales5', 'Layout BestSeller Page' => 'bestsales_page', 'Layout Child Category' => 'childcat2', 'Layout Child Category1' => 'childcat1', 'Layout Child Category2' => 'childcat3', 'Layout Child Category3' => 'childcat4', 'Layout Daily Deals'=>'layout6' ,'Layout Home 9' => 'theme1'),
		...
		**/
		function WS_Shortcode( $atts ){
			...
			switch ( $layout ) {			
				...
				break;	
				case 'default2':
					$path = sw_override_check( 'sw-slider', 'default2' );
				break;				
				case 'featured':
					$path = sw_override_check( 'sw-slider', 'featured' );
				break;
				case 'featured2':
					$path = sw_override_check( 'sw-slider', 'featured2' );
				break;
				case 'featured3':
					$path = sw_override_check( 'sw-slider', 'featured3' );
				break;
				case 'featured4':
					$path = sw_override_check( 'sw-slider', 'featured4' );
				break;
				case 'featured_mobile':
					$path = sw_override_check( 'sw-slider', 'featured-mobile' );
				break;
				case 'toprated':
				...
				break;
				case 'bestsales2':
					$path = sw_override_check( 'sw-slider', 'bestsales2' );
				break;
				case 'bestsales3':
					$path = sw_override_check( 'sw-slider', 'bestsales3' );
				break;
				case 'bestsales4':
					$path = sw_override_check( 'sw-slider', 'bestsales4' );
				break;
				case 'bestsales5':
					$path = sw_override_check( 'sw-slider', 'bestsales5' );
				break;
				case 'bestsales_page':
					$path = sw_override_check( 'sw-slider', 'bestsales_page' );
				break;
				case 'theme-mobile':
					$path = sw_override_check( 'sw-slider', 'theme-mobile' );
				break;
				case 'bestsales-mobile':
					$path = sw_override_check( 'sw-slider', 'bestsales-mobile' );
				break;				
				case 'childcat1':
				...
				break;
				case 'childcat4':
					$path = sw_override_check( 'sw-slider', 'childcat4' );
				break;
				case 'layout6':
					$path = sw_override_check( 'sw-slider', 'dailydeals' );
				break;
				case 'theme1':
					$path = sw_override_check( 'sw-slider', 'theme-home9' );
				break;
