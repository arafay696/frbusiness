	...
	class sw_woo_slider_countdown_widget extends WP_Widget { 
				...
				array(
				 ...
				 array(
				  ...
				  array(
					...
					"param_name" => "layout",
					"admin_label" => true,
					"value" => array( 'Layout Default' => 'default', 'Layout Countdown 1' => 'layout1', 'Layout Countdown 2' => 'layout3',  'Layout Tab Countdown' => 'layout_tab',  'Layout Tab Countdown2' => 'layout_tab2', 'Layout Tab Countdown3' => 'layout_tab3', 'Layout Tab Countdown4' => 'layout_tab4', 'Layout Countdown Mobile' => 'layout2'  ),
		...
		**/
		function WS_Shortcode_Countdown( $atts, $content = null ){
			...
			}elseif( $layout == 'layout_tab3' ){
				include( sw_override_check( 'sw-countdown-slider', 'tab-countdownt3' ) );			
			}elseif( $layout == 'layout_tab4' ){
				include( sw_override_check( 'sw-countdown-slider', 'tab-countdownt4' ) );			
			}
