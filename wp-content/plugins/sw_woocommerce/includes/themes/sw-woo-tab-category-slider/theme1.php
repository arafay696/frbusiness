...
?>
<div class="sw-woo-tab-cat2 sw-ajax" id="<?php echo esc_attr( 'category_' . $widget_id ); ?>" >
										...
										<div class="row">
											...
											<div class="item-center col-lg-4 col-md-4 col-sm-4">																				
												<div class="item-content">																			
													<h4 class="category"><a href="<?php echo esc_url( get_category_link( $term->term_id ) ); ?>"><?php echo esc_html__('Lookbook ','sw_woocommerce')?><?php echo str_replace( "-", " ", $category[$active] ); ?></a></h4>
