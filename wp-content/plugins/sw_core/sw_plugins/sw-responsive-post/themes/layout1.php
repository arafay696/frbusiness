						...
						<div class="item-detail">
							<div class="img_over">
								...
								if ( has_post_thumbnail( $post->ID ) ){
										echo get_the_post_thumbnail( $post->ID, 'revo_blog-responsive2' ) ? get_the_post_thumbnail( $post->ID, 'revo_blog-responsive2' ): '<img src="'.get_template_directory_uri().'/assets/img/placeholder/'.'large'.'.png" alt="No thumb">';		
								}else{
