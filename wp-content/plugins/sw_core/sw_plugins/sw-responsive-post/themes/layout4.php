...
?>
<div class="clear"></div>
<div id="<?php echo esc_attr( $id ) ?>" class="responsive-post-slider-home10 responsive-slider clearfix loading" data-lg="<?php echo esc_attr( $columns ); ?>" data-md="<?php echo esc_attr( $columns1 ); ?>" data-sm="<?php echo esc_attr( $columns2 ); ?>" data-xs="<?php echo esc_attr( $columns3 ); ?>" data-mobile="<?php echo esc_attr( $columns4 ); ?>" data-speed="<?php echo esc_attr( $speed ); ?>" data-scroll="<?php echo esc_attr( $scroll ); ?>" data-interval="<?php echo esc_attr( $interval ); ?>" data-autoplay="<?php echo esc_attr( $autoplay ); ?>">
						...
						<div class="item-detail">
							<div class="item-img">
								...
								if ( has_post_thumbnail( $post->ID ) ){
										echo get_the_post_thumbnail( $post->ID, 'revo_blog_home10' ) ? get_the_post_thumbnail( $post->ID, 'revo_blog_home10' ): '<img src="'.get_template_directory_uri().'/assets/img/placeholder/'.'large'.'.png" alt="No thumb">';		
								}else{
							...
							<div class="entry-content">
								...
								<div class="readmore"><a href="<?php echo get_permalink($post->ID);?>" title="View more" ><i class="fa fa-caret-right"></i><?php esc_html_e('Read more','sw_core');?></a></div>
							</div>
						</div>
					</div>
				</div>
