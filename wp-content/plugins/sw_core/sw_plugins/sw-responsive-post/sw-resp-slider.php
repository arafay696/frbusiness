			...
			vc_map( array(
				...
				'class'         => ''
				 ...
				 array(
					...
					"param_name" => "layout",
					"value" => array( 'Layout Default' => '1', 'Layout 1' => '2', 'Layout 2' => '3', 'Layout 3' => '4', 'Layout 4' =>'5', 'Layout 5' =>'6', 'Layout 6' =>'7' ),
		...
		**/
		function RP_Shortcode( $atts, $content = null ){
			...
			if( $layout == 1 ){
				...
				include( sw_core_override_check( 'sw-responsive-post', 'layout1' ) );
			}elseif( $layout == 3 ){
				include( sw_core_override_check( 'sw-responsive-post', 'layout2' ) );
			}elseif( $layout == 5 ){
				include( sw_core_override_check( 'sw-responsive-post', 'layout4' ) );
			}elseif( $layout == 6 ){
				include( sw_core_override_check( 'sw-responsive-post', 'layout5' ) );
			}elseif( $layout == 7 ){
				include( sw_core_override_check( 'sw-responsive-post', 'layout6' ) );
			}
			else{
				include( sw_core_override_check( 'sw-responsive-post', 'layout3' ) );
			}
