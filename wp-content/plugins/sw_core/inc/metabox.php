		...
		'fields'	=> array(
			...
			array(
				...
				'values' => array( '' => esc_html__( 'Default', 'sw_core' ), 'home-style1' => esc_html__( 'Home Style1', 'sw_core' ), 'home-style2' => esc_html__( 'Home Style2', 'sw_core' ),
					...
					'home-style6' => esc_html__( 'Home Style6', 'sw_core' ), 'home-style7' => esc_html__( 'Home Style7', 'sw_core' ), 'home-style8' => esc_html__( 'Home Style8', 'sw_core' ),
					'home-style9' => esc_html__( 'Home Style9', 'sw_core' ), 'home-style10' => esc_html__( 'Home Style10', 'sw_core' ), 'home-style11' => esc_html__( 'Home Style11', 'sw_core' ),
					'home-style12' => esc_html__( 'Home Style12', 'sw_core' ), 'home-style13' => esc_html__( 'Home Style13', 'sw_core' ), 'home-style14' => esc_html__( 'Home Style14', 'sw_core' ), 'page-style' => esc_html__( 'Page Style', 'sw_core' ), 'mobile-layout4' => esc_html__( 'Mobile Layout4', 'sw_core' )
				)
			),
			array(
				'type'	=> 'radio_img',
	...
	$sw_metabox_pages[] = array(
		...
		'fields'	=> array(
			...
			array(
				...
				'std'	 => '',
				'values' => array( '' => esc_html__( 'Header Style', 'sw_core' ), 'style1' => esc_html__( 'Header Style1', 'sw_core' ), 'style2' => esc_html__( 'Header Style2', 'sw_core' ), 'style3' => esc_html__( 'Header Style3', 'sw_core' ),
							'style4' => esc_html__( 'Header Style4', 'sw_core' ), 'style5' => esc_html__( 'Header Style5', 'sw_core' ),'style6' => esc_html__( 'Header Style6', 'sw_core' ), 'style7' => esc_html__( 'Header Style7', 'sw_core' ), 'style8' => esc_html__( 'Header Style8', 'sw_core' ),'style9' => esc_html__( 'Header Style9', 'sw_core' ), 'style10' => esc_html__( 'Header Style10', 'sw_core' ), 'style11' => esc_html__( 'Header Style11', 'sw_core' ), 'style12' => esc_html__( 'Header Style12', 'sw_core' ), 'style13' => esc_html__( 'Header Style13', 'sw_core' ), 'style14' => esc_html__( 'Header Style14', 'sw_core' )
				)
			)		
		)
	);
