 ...
 */
function revo_leadingslashit($string) {
	return '/' . revo_unleadingslashit($string);
}

function revo_unleadingslashit($string) {
	return ltrim($string, '/');
}
	...
	<div class="modal fade" id="login_form" tabindex="-1" role="dialog" aria-hidden="true">
		<div class="modal-dialog block-popup-login">
			...
			<?php 
				...
				$html = ob_get_clean();
				echo apply_filters( 'revo_custom_login_filter', $html );
			?>
		</div>
	</div>
<?php 	
	...
	if( !revo_mobile_check() ) : 
		...
		*/
		if( $sticky_menu ) :		
				...
				elseif( $revo_header_style == 'style11'|| $revo_header_style == 'style13' ){
					$output .= 'var sticky_navigation = function(){';
					$output .= 'var scroll_top = $(window).scrollTop();';
				...
				elseif( $revo_header_style == 'style2' || $revo_header_style == 'style3' || $revo_header_style == 'style5' || $revo_header_style == 'style6' || $revo_header_style == 'style7' || $revo_header_style == 'style8' || $revo_header_style == 'style9' || $revo_header_style == 'style10' || $revo_header_style == 'style12' || $revo_header_style == 'style14' ){
					$output .= 'var sticky_navigation_offset = $("#header .header-bottom").offset();';
					$output .= 'if( typeof sticky_navigation_offset != "undefined" ) {';
					$output .= 'var sticky_navigation_offset_top = sticky_navigation_offset.top;';
					$output .= 'var sticky_navigation = function(){';
...
if( !function_exists( 'sw_social_link' ) ) {
	function sw_social_link(){
		...
		$html .= '<div class="revo-socials"><ul>';
			...
			if( $gg_link != '' ):
				$html .= '<li><a href="'. esc_url( $gg_link ) .'" title="'. esc_attr__( 'Google+', 'revo' ) .'"><i class="fa fa-google-plus"></i></a></li>';
			endif;
