...
<div class="top-form revo-minicart6 pull-right">
	<div class="top-minicart-icon pull-right">
		<a class="cart-contents" href="<?php echo wc_get_cart_url(); ?>" title="<?php esc_attr_e('View your shopping cart', 'revo'); ?>"><i class="fa fa-shopping-basket" aria-hidden="true"></i><?php echo '<span class="minicart-number">'.$woocommerce->cart->cart_contents_count.'</span>';?></a>
		<div class="cart-title"><h3><?php esc_html_e('Your Cart: ','revo');?><?php echo $woocommerce->cart->get_cart_total(); ?></h3></div>
	</div>
